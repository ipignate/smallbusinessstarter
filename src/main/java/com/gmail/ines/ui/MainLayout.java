...
import com.gmail.ines.ui.components.navigation.bar.AppBar;
import com.gmail.ines.ui.components.navigation.bar.TabBar;
import com.gmail.ines.ui.components.navigation.drawer.NaviDrawer;
import com.gmail.ines.ui.components.navigation.drawer.NaviItem;
import com.gmail.ines.ui.components.navigation.drawer.NaviMenu;
import com.gmail.ines.ui.util.UIUtils;
import com.gmail.ines.ui.util.css.Overflow;
import com.gmail.ines.ui.views.Accounts;
import com.gmail.ines.ui.views.Principal;
import com.gmail.ines.ui.views.Payments;
import com.gmail.ines.ui.views.Statistics;
import com.gmail.ines.ui.views.personnel.Accountants;
import com.gmail.ines.ui.views.personnel.Managers;
...
public class MainLayout extends FlexBoxLayout
	...
	private void initNaviItems() {
		...
		menu.addNaviItem(VaadinIcon.HOME, "Home", Principal.class);
	...
	private void afterNavigationWithTabs(AfterNavigationEvent e) {
		...
		if (active == null) {
			if (tabBar.getTabCount() == 0) {
				tabBar.addClosableTab("", Principal.class);
			}
		} else {
			if (tabBar.getTabCount() > 0) {
