package com.gmail.ines.ui.components.navigation.bar;
...
import com.gmail.ines.ui.components.navigation.tab.NaviTab;
import com.gmail.ines.ui.components.navigation.tab.NaviTabs;
...
import static com.gmail.ines.ui.util.UIUtils.IMG_PATH;
...
public class AppBar extends FlexBoxLayout {
	...
	private void initTabs(NaviTab... tabs) {
		...
		addTab.addClickListener(e -> this.tabs
				.setSelectedTab(addClosableNaviTab("New Tab", Principal.class)));
